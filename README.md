...
### Как скачать
Пока уведомитель не обретет популярность, Windows будет считать его потенциально "опасной" программой :-) Поэтому, подтвержаайте, если что, что вы доверяете этой программе. Чтобы скачать всё — тексты, экзешники и заготовки файлов с настройками нажмите зеленую кнопку `<> Code ▾`, а далее выбирите пункт `Download ZIP`.<svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="21" height="30">
  <rect x="1px" y="0px" width="20px" height="30px" rx="2px" ry="2px"
        style="fill-opacity:1;stroke:none;fill:#7B50C8"/>
  <text x="2px" y="20px"
style="font-family:Arial,Helvetica,sans-serif;font-weight:400;font-size:12px;fill:#ffffff"
transform="rotate(-90,9,14) ">01</text>
</svg>
