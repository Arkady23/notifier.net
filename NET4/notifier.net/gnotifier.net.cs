...
public class f : Form {
    ...
    string ini=Folder+"gnotifier.net.ini", imap, email, passw, passs, url, message, min,
    ...
    void log(string x) {
      if(!(logSW != null)){
        logSW = new StreamWriter(new FileStream(Folder+"gnotifier.net.log", FileMode.Create,
    ...
    public f(string[] args) {
      ...
      nIcon.Icon = Icon.ExtractAssociatedIcon(Folder+"gnotifier.net.exe");
